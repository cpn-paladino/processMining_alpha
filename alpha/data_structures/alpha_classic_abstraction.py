import alpha.causal.algorithm as causal_algorithm
...
class ClassicAlphaAbstraction:
    ...
    def __init__(self, start_activities, end_activities, dfg, activity_key="concept:name"):
        ...
        self.__dfg = dfg
        self.__causal_relations = {k: v for k, v in causal_algorithm.apply(self.dfg, variant=causal_algorithm.CAUSAL_ALPHA).items() if
                                   v > 0}.keys()
